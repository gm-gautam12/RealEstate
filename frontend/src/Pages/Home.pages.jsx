                ...
                offerListings && offerListings.length > 0 && (
                    <div className="">
                        <div className="my-3">
                            ...
                            <Link to={"/search?offer=true"} className="text-sm text-blue-800 hover:text-blue-600">Show more offers</Link>
                        </div>
                ...
                rentListings && rentListings.length > 0 && (
                    <div className="">
                        <div className="my-3">
                            ...
                            <Link to={"/search?type=rent"} className="text-sm text-blue-800 hover:text-blue-600">Show more places for rent</Link>
                        </div>
                        <div className="flex flex-wrap gap-4">
                            {
